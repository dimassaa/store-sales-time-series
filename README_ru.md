...
рождественских закрытий действительно заполнены нулями в источнике; они
остаются нулями для STL-этапов и заменяются средним соседей **только** для
...
| Магазин 44 (тип A, крупный) | F_s 0.633, F_t 0.711 | ноутбук 03 / 04 |
| Магазин 26 (тип D/E, малый) | F_s 0.171, F_t 0.306 (слабая недельная сезонность) | ноутбук 03 / 04 |
